...
<?php 
        $query = mysqli_query($connection, "select * FROM tbl_constituent where admin_id = '$admin_id' ")or die(mysqli_error());
        $constituent = mysqli_num_rows($query);

        $query = mysqli_query($connection, "select * FROM tbl_indigency where admin_id = '$admin_id'")or die(mysqli_error());
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i> Home</a></div>
  </div>
  <div class="container-fluid">
   	<div class="quick-actions_homepage">
    <ul class="quick-actions">
          <li> <a href="#"> <i class="icon-dashboard"></i> My Dashboard </a> </li>
          <li> <a href="#"> <i class="icon-people"></i> Manage Constituent </a> </li>
          <li> <a href="#"> <i class="icon-calendar"></i> Manage Events </a> </li>
          <li> <a href="#"> <i class="icon-user"></i> Manage Accounts </a> </li>
        </ul>
   </div>
...
<div class="span7">
  <div class="widget-box">
    ...
    <?php $query = "SELECT * FROM tbl_events where admin_id = $admin_id order by  start_event DESC LIMIT 5"; 
