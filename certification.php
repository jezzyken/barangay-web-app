...
<li id="general">Billing</li>
    ...
    <input type="hidden" name="constituent_id" id="constituent_id" class="demoInputBox" value="<?php echo $id ?>" />
    ...
    <label>Address</label><span id="gender-error" class="registration-error"></span>
    <div><input type="text" name="gender" id="gender" class="demoInputBox" value="<?php echo $gender ?>" /></div>
    ...
    <a rel='{$id}' href='javascript:void(0)' id="preview" class='btn btn-info delete_link'  target="_blank" style="display:none; margin-top: 20px"> Print Receipt </a>
...
$(document).ready(function(){
  ...
  $(".delete_link").on('click', function(){
   ...
   var collectionname = "Certification"
